...
------------------------Gagner_I------------------------------
-- Création de la fragementation Horizontale de Gagner_I sur etupre
COPY FROM BRM2996A/"B@rry1999"@telline.univ-tlse3.fr:1521:etupre-
    TO BRM2996A/"B@rry1999"@telline.univ-tlse3.fr:1521:etupre-
REPLACE Gagner_I_1-
USING SELECT G_I.*-
...
-- Création de la fragementation Horizontale de Gagner_I su+r etusec
COPY FROM BRM2996A/"B@rry1999"@telline.univ-tlse3.fr:1521:etupre-
    TO BRM2996A/"B@rry1999"@brehat.univ-tlse3.fr:1521:etusec-
REPLACE Gagner_I_2-
USING SELECT G_I.*-
...
-- Création de la fragementation Horizontale de Gagner_I sur etuter
COPY FROM BRM2996A/"B@rry1999"@telline.univ-tlse3.fr:1521:etupre-
    TO BRM2996A/"B@rry1999"@telline.univ-tlse3.fr:1521:etuter-
REPLACE Gagner_I_3-
USING SELECT G_I.*-
